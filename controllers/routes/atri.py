...
class Atri:
	def __init__(self, state: Any):
		...
		self.TopDiv = state["TopDiv"]
		self.LeftDiv = state["LeftDiv"]
	...
	@property
	def TopDiv(self):
		self._getter_access_tracker["TopDiv"] = {}
		return self._TopDiv
	@TopDiv.setter
	def TopDiv(self, new_state):
		self._setter_access_tracker["TopDiv"] = {}
		global default_state
		self._TopDiv = Flex(new_state, default_state["TopDiv"])

	@property
	def LeftDiv(self):
		self._getter_access_tracker["LeftDiv"] = {}
		return self._LeftDiv
	@LeftDiv.setter
	def LeftDiv(self, new_state):
		self._setter_access_tracker["LeftDiv"] = {}
		global default_state
		self._LeftDiv = Flex(new_state, default_state["LeftDiv"])
	...
	def Div2(self, new_state):
		...
		global default_state
		self._Div2 = Flex(new_state, default_state["Div2"])
