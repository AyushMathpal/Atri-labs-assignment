...
import { useNavBarCb, useFlex2Cb, useFlex3Cb, useTopDivCb, useLeftDivCb, useFlex7Cb, useFlex6Cb, useDiv2Cb, useFlex9Cb, useFlex10Cb, useCarousel1Cb, useImage1Cb, useButton10Cb, useButton11Cb, useButton12Cb, useButton13Cb, useButton16Cb, useButton20Cb, useButton21Cb, useTextBox3Cb, useTextBox4Cb, useTextBox5Cb, useButton25Cb, useButton26Cb, useImage3Cb, useTextBox6Cb, useImage4Cb, useImage5Cb, useImage6Cb, useImage7Cb } from "../page-cbs/Home";
...
const TopDivProps = useStore((state)=>state["Home"]["TopDiv"]);
const TopDivIoProps = useIoStore((state)=>state["Home"]["TopDiv"]);
const TopDivCb = useTopDivCb()
const LeftDivProps = useStore((state)=>state["Home"]["LeftDiv"]);
const LeftDivIoProps = useIoStore((state)=>state["Home"]["LeftDiv"]);
const LeftDivCb = useLeftDivCb()
...
<Flex className="p-Home TopDiv bpt" {...TopDivProps} {...TopDivCb} {...TopDivIoProps}>
<Flex className="p-Home LeftDiv bpt" {...LeftDivProps} {...LeftDivCb} {...LeftDivIoProps}>
...
<Flex className="p-Home Div2 bpt" {...Div2Props} {...Div2Cb} {...Div2IoProps}>
